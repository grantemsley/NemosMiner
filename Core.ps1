...
Function NPMCycle {
    ...
    $Variables.Miners = if (Test-Path "Miners") {@(Get-ChildItemContent "Miners"; Get-ChildItemContent "OptionalMiners"; Get-ChildItemContent "CustomMiners") | ForEach {$_.Content | Add-Member @{Name = $_.Name} -PassThru} | 
